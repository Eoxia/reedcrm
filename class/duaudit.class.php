...
class DuAudit extends SaturneObject
{
    ...
    public $fields = [
        ...
        // Real date agreed with the client (an appointment), as opposed to the yearly theoretical date above.
        'date_rdv'          => ['type' => 'date',         'label' => 'FollowupAuditRdv',    'enabled' => 1, 'position' => 102, 'notnull' => 0, 'visible' => 1],
