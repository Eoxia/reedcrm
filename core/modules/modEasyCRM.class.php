...
class modEasyCRM extends DolibarrModules
{
    ...
    public function init($options = ''): int
    {
        ...
        $extrafields->addExtraField('easycrm_prod_serv', 'ProdServTagsCategories', 'varchar', 200, 255, 'product', 0, 0,  '', '', 0, '', 2, '',  '(($form = new Form($db)) ? $form->showCategories($obj->rowid, \'product\', 1, 0) : \'\')', '0',  'easycrm@easycrm',  'isModEnabled("easycrm")');
        //Extra Fields on Customers/Prospects
        $extrafields->addExtraField('easycrm_cust_prosp', 'CustProspTagsCategories', 'varchar', 200, 255, 'thirdparty', 0, 0,  '', '', 0, '', 2, '',  '(($form = new Form($db)) ? $form->showCategories($obj->rowid, \'customer\', 1, 0) : \'\')', '0',  'easycrm@easycrm',  'isModEnabled("easycrm")');
        //Extra Fields on Vendors
        $extrafields->addExtraField('easycrm_vendor', 'VendorsTagsCategories', 'varchar', 200, 255, 'thirdparty', 0, 0,  '', '', 0, '', 2, '',  '(($form = new Form($db)) ? $form->showCategories($obj->rowid, \'supplier\', 1, 0) : \'\')', '0',  'easycrm@easycrm',  'isModEnabled("easycrm")');
        //Extra Fields on Contacts
        $extrafields->addExtraField('easycrm_contact', 'ContactsTagsCategories', 'varchar', 200, 255, 'socpeople', 0, 0,  '', '', 0, '', 2, '',  '(($form = new Form($db)) ? $form->showCategories($obj->rowid, \'contact\', 1, 0) : \'\')', '0',  'easycrm@easycrm',  'isModEnabled("easycrm")');
        //Extra Fields on Projects/LEads
        $extrafields->addExtraField('easycrm_proj_leads', 'ProjectsTagsCategories', 'varchar', 200, 255, 'projet', 0, 0,  '', '', 0, '', 2, '',  '(($form = new Form($db)) ? $form->showCategories($object->id, \'project\', 1, 0) : \'\')', '0',  'easycrm@easycrm',  'isModEnabled("easycrm")');
        //Extra Fields on Events
        $extrafields->addExtraField('easycrm_events', 'EventsTagsCategories', 'varchar', 200, 255, 'actioncomm', 0, 0,  '', '', 0, '', 2, '',  '(($form = new Form($db)) ? $form->showCategories($obj->id, \'actioncomm\', 1, 0) : \'\')', '0',  'easycrm@easycrm',  'isModEnabled("easycrm")');
