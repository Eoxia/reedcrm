...
class modReedCRM extends DolibarrModules
{
    ...
    public function init($options = ''): int
    {
        ...
        $extraFieldsArrays = [
            ...
            'reedcrm_website'      => ['Label' => 'Website',                'type' => 'url',     'length' => 255, 'elementtype' => ['projet'], 'position' => $this->numero . 70, 'list' => 1, 'enabled' => 'isModEnabled(\'reedcrm\') && isModEnabled(\'project\')', 'alwayseditable' => 1],
