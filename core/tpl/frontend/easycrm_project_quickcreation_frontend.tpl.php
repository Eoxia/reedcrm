...
<!-- File start-->
<div class="template-pwa project-container">
    <div id="id-top" class="page-header side-nav-vert">
        ...
        <div class="col">
            ...
            print '<a class="wpeo-button nav-element" href="' . dol_buildpath('custom/easycrm/view/map.php?from_type=project&source=pwa', 1) . '">' . $backToMap . '</a>'; ?>
        </div>
    </div>
...
//                print 'img_picto('', $extraFields->attributes['projet']['picto'][$key], 'class="pictofixedwidth"')';
    ...
    <div id="id-bot" class="page-footer">
        <button type="submit" class="button button-add button-square">
