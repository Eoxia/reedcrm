<?php
/**
 * \file    view/frontend/pwa_tiers.php
 * \ingroup reedcrm
 * \brief   Page to list ThirdParties on frontend App view
 */
...
llxHeader('', $title, $help_url, '', 0, 0, $moreJS, $moreCSS, '', 'template-pwa pwa-tiers-list');
...
$pwaHeaderCenterHtml = '<div style="background: #e2e8f0; padding: 4px 10px; border-radius: 12px; font-size: 13px; font-weight: bold; color: #475569;"><i class="fas fa-building"></i> 99 Tiers</div>';
require_once __DIR__ . '/../../core/tpl/frontend/reedcrm_pwa_header.tpl.php';

print '<div class="pwa-container" style="padding: 15px;">';
print '  <h2><i class="fas fa-building" style="color: #64748b;"></i> ' . $langs->trans('ThirdParties') . '</h2>';
