...
foreach ($latestProjects as $project) {
    ...
    $amount    = $project->opp_amount ? price($project->opp_amount, 0, '', 11, -1, -1, 'auto') : '0 Ôé¼';
    ...
    print '<div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 10px;">';
        ...
        print '<div style="display: flex; flex-direction: column; gap: 8px; flex: 1; min-width: 0;">';
            ...
            if (!empty($title)) {
                ...
                print '<div class="fast-css-tooltip" ' . $descAttr . ' style="color: #4a5568; font-size: 0.95em; display: flex; align-items: center; position: relative; cursor: pointer; width: 100%; max-width: 100%; overflow: hidden;">';
                    ...
                    if ($statVal == 1) {
                        ...
                        print '<div style="width: 10px; height: 10px; background-color: #95a5a6; border-radius: 50%; display: inline-block; flex-shrink: 0;" title="Cl├┤tur├®"></div>';
                    }
            ...
            $hFirstName = $cFirstName ? dol_escape_htmltag($cFirstName) : '<span style="color:#cbd5e0; font-style:italic;">Pr├®nom</span>';
            $hLastName = $cLastName ? dol_escape_htmltag($cLastName) : '<span style="color:#cbd5e0; font-style:italic;">Nom</span>';
            $hPhone = $cPhone ? dol_escape_htmltag($cPhone) : '<span style="color:#cbd5e0; font-style:italic;">T├®l├®phone</span>';
            ...
            print '<div class="contact-inline-wrapper" style="color: #718096; font-size: 0.9em; margin-bottom: 2px; position: relative;" data-project-id="'.$project->id.'">';
                print '<div class="contact-display-area" style="display: flex; align-items: center; gap: 0px; flex-wrap: wrap; padding: 2px 0;">';
                    ...
                    print '<span class="inline-edit-contact" data-field="firstname" data-val="'.dol_escape_htmltag($cFirstName).'" style="cursor: pointer; border-bottom: 1px dashed #cbd5e0; line-height: 1; padding-bottom: 1px; transition: color 0.3s; margin-right: 4px;" title="Modifier le pr├®nom">' . $hFirstName . '</span>';
                    ...
                    print $linkPhone;
                    print '<span class="inline-edit-contact" data-field="phone" data-val="'.dol_escape_htmltag($cPhone).'" style="cursor: pointer; border-bottom: 1px dashed #cbd5e0; line-height: 1; padding-bottom: 1px; transition: color 0.3s; margin-right: 8px;" title="Modifier le t├®l├®phone">' . $hPhone . '</span>';
                    print '<span style="color: #cbd5e0; margin-right: 8px;">&bull;</span>';
                ...
                if ($soc->fetch($tiersId) > 0) {
                    print '<div style="color: #64748b; font-size: 0.95em; margin-bottom: 2px; display: flex; align-items: center; gap: 0px;" title="Tiers du projet">';
                        ...
                        if (!empty($soc->phone)) {
                            ...
                            print '<i class="fas fa-phone copy-action-icon" data-copy="'.dol_escape_htmltag($soc->phone).'" style="color: #64748b; font-size: 1.0em; margin-right: 6px; cursor: copy;" title="Copier le num├®ro"></i>';
                            print '<a href="tel:' . dol_escape_htmltag($soc->phone) . '" class="prevent-edit-click" style="color: inherit; text-decoration: none;" title="Appeler le num├®ro">' . dol_escape_htmltag($soc->phone) . '</a>';
                        }
                        if (!empty($soc->email)) {
                            print '<span style="color: #cbd5e0; margin: 0 4px;">&bull;</span>';
